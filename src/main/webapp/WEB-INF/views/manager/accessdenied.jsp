...
<center>
<h1>Welcome to Spring Boot Manager Access Denied Error Page</h1>

<h2>You are in Spring Boot Manager Bad Credential Error page</h2>
<br><a href="/manager/login">Home</a>
<br><br>
<%
